...
(function(n, t) {
    ...
    function e(r, f, e, o, s) {
        ...
        function ft(n) {
            var v = f.defaultImage, p = f.placeholder, k = f.imageBase, s = f.srcsetAttribute, l = f.loaderAttribute, a = f._f || {}, e, w;
            for (n = i(n).filter(function() {
                var n = i(this)
                  , r = nt(this);
                return !n.data(f.handledName) && (n.attr(f.attribute) || n.attr(s) || n.attr(l) || a[r] !== t)
            ...
            w = n.length; e < w; e++) {
                ...
                o === c && v && !u.attr(h) ? u.attr(h, v) : o !== c && p && (!u.css(y) || u.css(y) === "none") && u.css(y, "url('" + p + "')")
            }
        }
        function d(n, t) {
            var o;
            ...
            for (o = 0; o < s.length; o++)
                if (n || t || ot(s[o])) {
                    ...
                    !u.data(l) && (!f.visibleOnly || u.is(":visible")) && ((v || u.attr(k)) && (a === c && (p + v !== u.attr(h) || u.attr(k) !== u.attr(b)) || a !== c && p + v !== u.css(y)) || d) && (w = !0,
                    u.data(l, !0),
                    et(u, a, p, d))
                }
        ...
        function et(n, t, r, u) {
            ...
            if (u) {
                ...
                e.one(v, o).one(a, function() {
                    n.hide();
                    t === c ? n.attr(k, e.attr(k)).attr(b, e.attr(b)).attr(h, e.attr(h)) : n.css(y, "url('" + e.attr(h) + "')");
                    n[f.effect](f.effectTime);
                    ft && (n.removeAttr(d + " " + nt + " " + ut + " " + f.imageBaseAttribute),
                    p !== k && n.removeAttr(p));
                    n.data(et, !0);
                    l(rt, n);
                    e.remove();
                ...
                w = (it && ot ? ot : n.attr(d)) || "";
                e.attr(k, n.attr(p)).attr(b, n.attr(nt)).attr(h, w ? r + w : null);
        ...
        function l(n) {
            return (n = f[n]) ? (n.apply(r, [].slice.call(arguments, 1)),
            !0) : !1
        }
        var g = 0
          , p = -1
    ...
    function r(r, u) {
        ...
        return o.config = function(n, i) {
            return i === t ? h[n] : (h[n] = i,
            o)
        }
        ,
        o.addItems = function(n) {
            return s.a && s.a(typeof n == "string" ? i(n) : n),
            o
        }
        ,
        o.getItems = function() {
        ...
        ,
        o.force = function(n) {
            return s.f && s.f(typeof n == "string" ? i(n) : n),
            o
        }
        ,
        o.loadAll = function() {
        ...
        ,
        o.destroy = function() {
            return i(h.appendScroll).off("." + c, s.e),
            i(n).off("." + c),
            s = {},
            t
        }
    ...
    ;
    i.Lazy = i.lazy = function(n, i, u) {
        var f, s, e, h, o, c;
        if (typeof i == "function" && (u = i,
        i = []),
        typeof u == "function") {
            for (n = Array.isArray(n) ? n : [n],
            i = Array.isArray(i) ? i : [i],
            f = r.prototype.config,
            s = f._f || (f._f = {}),
            e = 0,
            h = n.length; e < h; e++)
                (f[n[e]] === t || typeof f[n[e]] == "function") && (f[n[e]] = u);
            for (o = 0,
            c = i.length; o < c; o++)
                s[i[o]] = n[0]
        }
...
(function(n) {
    function t(t, i, r, u) {
        ...
        var f;
        (u === "POST" || u === "PUT") && t.config("ajaxCreateData") && (f = t.config("ajaxCreateData").apply(t, [i]));
        n.ajax({
            url: i.attr("data-src"),
            ...
            success: function(n) {
                i.html(n);
                r(!0);
                t.config("removeAttribute") && i.removeAttr("data-src data-method data-type")
            },
            error: function() {
                r(!1)
            }
    ...
    n.lazy(["av", "audio", "video"], ["audio", "video"], function(t, i) {
        ...
        if (f === "audio" || f === "video") {
            ...
            t.one("loadedmetadata", function() {
                i(!0)
            }).off("load error").attr("poster", t.attr("data-poster"));
            u.length ? u.each(s) : t.attr(r) ? (n.each(t.attr(r).split(","), function(i, r) {
                var u = r.split("|");
                t.append(n("<source>").one("error", o).attr({
                    src: u[0].trim(),
                    type: u[1].trim()
                }))
            }),
            this.config("removeAttribute") && t.removeAttr(r)) : i(!1);
            e.length && e.each(s)
        } else
            i(!1)
    })
    ...
    n.lazy(["frame", "iframe"], "iframe", function(t, i) {
        ...
        if (t[0].tagName.toLowerCase() === "iframe") {
            var r = "data-src"
              , u = "data-error-detect"
              , e = t.attr(u);
            e !== "true" && e !== "1" ? (t.attr("src", t.attr(r)),
            f.config("removeAttribute") && t.removeAttr(r + " " + u)) : n.ajax({
                url: t.attr(r),
                dataType: "html",
                crossDomain: !0,
                xhrFields: {
...
(function(n) {
    ...
    function o(t, i, r) {
        var u = n("<img>").one("load", function() {
            r(!0)
        }).one("error", function() {
            r(!1)
        }).appendTo(t).attr("src", i);
        u.complete && u.trigger("load")
    }
    function s(n, t) {
        var r, i, u;
        if (t)
        ...
        if (y === "picture") {
            ...
            if (v.length)
                ...
                l.length === 1) {
                    ...
                    h.attr(t) ? (o(h, a + h.attr(t), c),
                    this.config("removeAttribute") && h.removeAttr(t)) : c(!1);
            else
                h.attr(i) ? (n("<source>").attr({
                    media: h.attr(r),
                    sizes: h.attr(u),
                    type: h.attr(f),
                    srcset: s(h.attr(i), a)
                ...
                o(h, a + h.attr(t), c),
                this.config("removeAttribute") && h.removeAttr(t + " " + i + " " + r + " " + u + " " + f)) : c(!1)
        } else
            c(!1)
    })
}
...
(function(n) {
    n.lazy(["js", "javascript", "script"], "script", function(n, t) {
        n[0].tagName.toLowerCase() === "script" ? (n.attr("src", n.attr("data-src")),
        this.config("removeAttribute") && n.removeAttr("data-src")) : t(!1)
    })
}
)(window.jQuery || window.Zepto);
/*!
...
(function(n) {
    n.lazy("vimeo", function(n, t) {
        n[0].tagName.toLowerCase() === "iframe" ? (n.attr("src", "https://player.vimeo.com/video/" + n.attr("data-src")),
        this.config("removeAttribute") && n.removeAttr("data-src")) : t(!1)
    })
}
)(window.jQuery || window.Zepto);
...
(function(n) {
    n.lazy(["yt", "youtube"], function(n, t) {
        n[0].tagName.toLowerCase() === "iframe" ? (n.attr("src", "https://www.youtube-nocookie.com/embed/" + n.attr("data-src") + "?rel=0&amp;showinfo=0"),
        this.config("removeAttribute") && n.removeAttr("data-src")) : t(!1)
    })
}
)(window.jQuery || window.Zepto),
function(n, t) {
    typeof define == "function" && define.amd ? define(["jquery"], t) : typeof exports == "object" ? module.exports = t(require("jquery")) : n.jquery_dotdotdot_js = t(n.jQuery)
}(this, function(n) {
    return !function(n) {
        "use strict";
        function e() {
        ...
        var t = "dotdotdot", o = "3.2.2", i, f, r, u;
        n[t] && n[t].version > o || (n[t] = function(n, i) {
            this.$dot = n;
        ...
        n[t].prototype = {
            ...
            truncate: function() {
                ...
                var n = !1;
                return this._fits() || (n = !0,
                this._truncateToNode(this.$inner[0])),
                this.$dot[n ? "addClass" : "removeClass"](i.truncated),
            ...
            watch: function() {
                ...
                this.unwatch();
                t = {};
                "window" == this.opts.watch ? u.on(r.resize + n.uniqueId, function() {
            ...
            _truncateToNode: function(t) {
                ...
                if (n(t).contents().each(function() {
                    var r = n(this), t;
                    r.hasClass(i.keep) || (t = document.createComment(""),
                    r.replaceWith(t),
                    u.push(this),
                    o.push(t))
                }),
                u.length) {
                    for (r = 0; r < u.length; r++)
                        if (n(o[r]).replaceWith(u[r]),
                        n(u[r]).append(this.opts.ellipsis),
                        h = this._fits(),
                        n(this.opts.ellipsis, u[r]).remove(),
                        !h) {
                            if ("node" == this.opts.truncate && r > 1)
                                return void n(u[r - 2]).remove();
                            break
                        }
                    for (s = r; s < o.length; s++)
                        n(o[s]).remove();
                    f = u[Math.max(0, Math.min(r, u.length - 1))];
                    1 == f.nodeType && (e = n("<" + f.nodeName + " />"),
                    e.append(this.opts.ellipsis),
                    n(f).replaceWith(e),
                    this._fits() ? e.replaceWith(f) : (e.remove(),
                    f = u[Math.max(0, r - 1)]));
                    1 == f.nodeType ? this._truncateToNode(f) : this._truncateToWord(f)
                }
            },
            _truncateToWord: function(n) {
                for (var i = n, t = this, e = this.__getTextContent(i), u = e.indexOf(" ") !== -1 ? " " : "ã€€", f = e.split(u), o = "", r = f.length; r >= 0; r--)
                    if (o = f.slice(0, r).join(u),
                    t.__setTextContent(i, t._addEllipsis(o)),
                    t._fits()) {
                        "letter" == t.opts.truncate && (t.__setTextContent(i, f.slice(0, r + 1).join(u)),
                        t._truncateToLetter(i));
                        break
                    }
            },
            _truncateToLetter: function(n) {
                for (var t = this, f = this.__getTextContent(n), u = f.split(""), i = "", r = u.length; r >= 0 && (i = u.slice(0, r).join(""),
                !i.length || (t.__setTextContent(n, t._addEllipsis(i)),
                !t._fits())); r--)
                    ;
            },
            _fits: function() {
            ...
            _addEllipsis: function(t) {
                for (var i = [" ", "ã€€", ",", ";", ".", "!", "?"]; n.inArray(t.slice(-1), i) > -1; )
                    t = t.slice(0, -1);
                return t + this.__getTextContent(this.opts.ellipsis)
            },
            _getOriginalContent: function() {
                var t = this;
                return this.$dot.find("script, style").addClass(i.keep),
                this.opts.keep && this.$dot.find(this.opts.keep).addClass(i.keep),
                this.$dot.find("*").not("." + i.keep).add(this.$dot).contents().each(function() {
                    var r = this
                      , i = n(this);
                    if (3 == r.nodeType) {
                        if ("" == n.trim(t.__getTextContent(r)) && (i.parent().is("table, thead, tbody, tfoot, tr, dl, ul, ol, video") || i.prev().is("div, p, table, td, td, dt, dd, li") || i.next().is("div, p, table, td, td, dt, dd, li") || !i.prev().length || !i.next().length))
            ...
            _getMaxHeight: function() {
                ...
                for (var n = ["maxHeight", "height"], i = 0, t = 0; t < n.length; t++)
                    if (i = window.getComputedStyle(this.$dot[0])[n[t]],
                    "px" == i.slice(-2)) {
                        i = parseFloat(i);
                        break
                    }
                ...
                for (t = 0; t < n.length; t++)
                    r = window.getComputedStyle(this.$dot[0])[n[t]],
                    "px" == r.slice(-2) && (i -= parseFloat(r));
                return Math.max(i, 0)
            },
...
(function(n, t) {
    ...
    function r(t) {
        return n.expr.pseudos.visible(t) && !n(t).parents().addBack().filter(function() {
    ...
    n.fn.extend({
        disableSelection: function() {
            return this.on((n.support.selectstart ? "selectstart" : "mousedown") + ".ui-disableSelection", function(n) {
                n.preventDefault()
            })
        },
...
function(n, t) {
    ...
    n.widget.bridge = function(r, u) {
        ...
        n.fn[r] = function(e) {
            ...
            h ? this.each(function() {
                ...
                return u ? typeof u[e] != "function" || e.charAt(0) === "_" ? n.error("no such method '" + e + "' for " + r + " widget instance") : (i = u[e].apply(u, o),
    ...
    n.Widget.prototype = {
        ...
        destroy: function() {
            this._destroy();
            this.element.off(this.eventNamespace).removeData(this.widgetName).removeData(this.widgetFullName).removeData(n.camelCase(this.widgetFullName));
...
function(n) {
    ...
    n.widget("ui.mouse", {
        ...
        _mouseDestroy: function() {
            ...
            this._mouseMoveDelegate && n(document).off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate)
        },
        _mouseDown: function(i) {
            if (!t) {
                ...
                ;
                n(document).on("mousemove." + this.widgetName, this._mouseMoveDelegate).on("mouseup." + this.widgetName, this._mouseUpDelegate);
                return i.preventDefault(),
                t = !0,
                !0
            }
        ...
        _mouseUp: function(t) {
            return n(document).off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate),
...
function(n, t) {
    ...
    n.position = {
        ...
        getWithinInfo: function(t) {
            var i = n(t || window)
              , r = i[0] != null && i[0] === i[0].window ? i[0] : null
    ...
    n.fn.position = function(t) {
        ...
        t.at[1] === "bottom" ? p.top += l : t.at[1] === "center" && (p.top += l / 2),
        b = a(nt.at, f, l),
        p.left += b[0],
        p.top += b[1],
        this.each(function() {
...
function(n) {
    n.widget("ui.draggable", n.ui.mouse, {
        ...
        _mouseStop: function(t) {
            ...
            this.dropped = !1),
            this.options.helper === "original" && !n.contains(this.element[0].ownerDocument, this.element[0])) ? !1 : (this.options.revert === "invalid" && !i || this.options.revert === "valid" && i || this.options.revert === !0 || typeof this.options.revert == "function" && this.options.revert.call(this.element, i) ? n(this.helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10), function() {
        ...
        _createHelper: function(t) {
            var r = this.options
              , i = typeof r.helper == "function" ? n(r.helper.apply(this.element[0], [t])) : r.helper === "clone" ? this.element.clone().removeAttr("id") : this.element;
        ...
        _generatePosition: function(t) {
            ...
            i = [this.containment[0] + e.left, this.containment[1] + e.top, this.containment[2] + e.left, this.containment[3] + e.top]) : i = this.containment,
            t.pageX - this.offset.click.left < i[0] && (o = i[0] + this.offset.click.left),
            t.pageY - this.offset.click.top < i[1] && (s = i[1] + this.offset.click.top),
            t.pageX - this.offset.click.left > i[2] && (o = i[2] + this.offset.click.left),
            t.pageY - this.offset.click.top > i[3] && (s = i[3] + this.offset.click.top)),
            r.grid && (u = r.grid[1] ? this.originalPageY + Math.round((s - this.originalPageY) / r.grid[1]) * r.grid[1] : this.originalPageY,
            s = i ? u - this.offset.click.top >= i[1] || u - this.offset.click.top > i[3] ? u : u - this.offset.click.top >= i[1] ? u - r.grid[1] : u + r.grid[1] : u,
            f = r.grid[0] ? this.originalPageX + Math.round((o - this.originalPageX) / r.grid[0]) * r.grid[0] : this.originalPageX,
            o = i ? f - this.offset.click.left >= i[0] || f - this.offset.click.left > i[2] ? f : f - this.offset.click.left >= i[0] ? f - r.grid[0] : f + r.grid[0] : f)),
            {
    ...
    n.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(t, i) {
            for (var e, o, s, h, c, a, l, v, w, r = n(this).data("ui-draggable"), b = r.options, f = b.snapTolerance, y = i.offset.left, k = y + r.helperProportions.width, p = i.offset.top, d = p + r.helperProportions.height, u = r.snapElements.length - 1; u >= 0; u--) {
                if (c = r.snapElements[u].left,
                a = c + r.snapElements[u].width,
                l = r.snapElements[u].top,
    ...
    n.widget("ui.menu", {
        ...
        _create: function() {
            ...
            this.element.uniqueId().addClass("ui-menu ui-widget ui-widget-content ui-corner-all").toggleClass("ui-menu-icons", !!this.element.find(".ui-icon").length).attr({
                ...
                tabIndex: 0
            }).on("click" + this.eventNamespace, n.proxy(function(n) {
...
function(n) {
    ...
    n.widget("ui.slider", n.ui.mouse, {
        ...
        _mouseCapture: function(t) {
            ...
            this._handleIndex = u,
            i.addClass("ui-state-active").trigger("focus"),
            e = i.offset(),
        ...
        _setOption: function(t, i) {
            ...
            Array.isArray(this.options.values) && (u = this.options.values.length);
...
!function(n) {
    ...
    var t = function(i, r, u) {
        ...
        this.$button = null;
        this.$menu = null;
        this.options = n.extend({}, n.fn.selectpicker.defaults, this.$element.data(), typeof r == "object" && r);
    ...
    t.prototype = {
        ...
        init: function() {
            ...
            t !== undefined) {
                ...
                n('label[for="' + t + '"]').on("click", function(n) {
                    n.preventDefault();
        ...
        createDropdown: function() {
            var t = this.multiple ? " show-tick" : ""
              ...
              , r = this.options.liveSearch ? '<div class="bootstrap-select-searchbox"><input type="text" class="input-block-level form-control" /><\/div>' : ""
              , u = '<div class="btn-group bootstrap-select' + t + '" role="combobox"><button type="button" class="btn filter-option" data-toggle="dropdown"><\/button><button type="button" class="btn dropdown-toggle" data-toggle="dropdown" tabindex="-1"><span class="acn-icon icon-arrow-dropdown"><\/span><span class="sr-only">Toggle Dropdown<\/span><\/button><div class="dropdown-menu open">' + i + r + '<ul class="dropdown-menu inner " role="menu"><\/ul><\/div><\/div>';
            return n(u)
        },
        createView: function() {
            var n = this.createDropdown(), t;
            return typeof this.$element.data("ul-id") != "undefined" && this.$element.data("label-id") != "undefined" && (n.attr({
                "aria-labelledby": this.$element.data("label-id"),
                "aria-owns": this.$element.data("ul-id")
            }),
            n.find("ul").attr("id", this.$element.data("ul-id"))),
            t = this.createLi(),
            n.find("ul").append(t),
            n
        },
        ...
        createLi: function() {
            ...
            return this.$element.find("option").each(function() {
                var r = n(this)
                  ...
                  , h = r.data("subtext") !== undefined ? '<small class="muted text-muted">' + r.data("subtext") + "<\/small>" : ""
                  , o = r.data("icon") !== undefined ? '<i class="' + i.options.iconBase + " " + r.data("icon") + '"><\/i> ' : "";
                if (o !== "" && (r.is(":disabled") || r.parent().is(":disabled")) && (o = "<span>" + o + "<\/span>"),
                r.data("content") || (u = o + '<span class="text">' + u + h + "<\/span>"),
                i.options.hideDisabled && (r.is(":disabled") || r.parent().is(":disabled")))
                    t.push('<a style="min-height: 0; padding: 0"><\/a>');
                else if (r.parent().is("optgroup") && r.data("divider") !== !0)
                    if (r.index() === 0) {
                        var s = r.parent().attr("label")
                          , c = r.parent().data("subtext") !== undefined ? '<small class="muted text-muted">' + r.parent().data("subtext") + "<\/small>" : ""
                          , l = r.parent().data("icon") ? '<i class="' + r.parent().data("icon") + '"><\/i> ' : "";
                        s = l + '<span class="text">' + s + c + "<\/span>";
                        r[0].index !== 0 ? t.push('<div class="div-contain"><div class="divider"><\/div><\/div><dt>' + s + "<\/dt>" + i.createA(u, "opt " + f, e)) : t.push("<dt>" + s + "<\/dt>" + i.createA(u, "opt " + f, e))
                    } else
                        t.push(i.createA(u, "opt " + f, e));
                else
                    r.data("divider") === !0 ? t.push('<div class="div-contain"><div class="divider"><\/div><\/div>') : n(this).data("hidden") === !0 ? t.push("") : t.push(i.createA(u, f, e))
            }),
            n.each(t, function(n, t) {
                r += "<li rel=" + n + ">" + t + "<\/li>"
            }),
            this.multiple || this.$element.find("option:selected").length !== 0 || this.options.title || this.$element.find("option").eq(0).prop("selected", !0).attr("selected", "selected"),
            n(r)
        },
        ...
        render: function() {
            ...
            this.$element.find("option").each(function(i) {
                t.setDisabled(i, n(this).is(":disabled") || n(this).parent().is(":disabled"));
                t.setSelected(i, n(this).is(":selected"))
            });
            this.tabIndex();
            i = this.$element.find("option:selected").map(function() {
                var i = n(this), u = i.data("icon") && t.options.showIcon ? '<i class="' + t.options.iconBase + " " + i.data("icon") + '"><\/i> ' : "", r;
                return r = t.options.showSubtext && i.attr("data-subtext") && !t.multiple ? ' <small class="muted text-muted">' + i.data("subtext") + "<\/small>" : "",
                i.data("content") && t.options.showContent ? i.data("content") : i.attr("title") !== undefined ? i.attr("title") : u + i.html() + r
            }).toArray();
            r = this.multiple ? i.join(this.options.multipleSeparator) : i[0];
            this.multiple && this.options.selectedTextFormat.indexOf("count") > -1 && (u = this.options.selectedTextFormat.split(">"),
            f = this.options.hideDisabled ? ":not([disabled])" : "",
            (u.length > 1 && i.length > u[1] || u.length == 1 && i.length >= 2) && (r = this.options.countSelectedText.replace("{0}", i.length).replace("{1}", this.$element.find('option:not([data-divider="true"]):not([data-hidden="true"])' + f).length)));
            r || (r = this.options.title !== undefined ? this.options.title : this.options.noneSelectedText);
            this.$button.attr("title", n.trim(r));
            this.$newElement.find(".filter-option").html('<span class="shortText dotdot">' + r + "<\/span>")
        },
        setStyle: function(n, t) {
            ...
            t == "add" ? this.$button.addClass(i) : t == "remove" ? this.$button.removeClass(i) : (this.$button.removeClass(this.options.style),
        ...
        setSize: function() {
            var r = this, t = this.$menu, h = t.find(".inner"), k = this.$newElement.outerHeight(), c = this.$newElement.data("liHeight"), l = this.$newElement.data("headerHeight"), a = this.$newElement.data("searchHeight"), d = t.find("li .divider").outerHeight(!0), u = parseInt(t.css("padding-top")) + parseInt(t.css("padding-bottom")) + parseInt(t.css("border-top-width")) + parseInt(t.css("border-bottom-width")), v = this.options.hideDisabled ? ":not(.disabled)" : "", y = n(window), e = u + parseInt(t.css("margin-top")) + parseInt(t.css("margin-bottom")) + 2, i, f, o, p = function() {
            ...
            this.options.size == "auto") {
                s = function() {
                    ...
                    p();
                    i = o - e;
                    r.options.dropupAuto && r.$newElement.toggleClass("dropup", f > o && i - e < t.height());
                    r.$newElement.hasClass("dropup") && (i = f - e - 70);
                    n = t.find("li").length + t.find("dt").length > 3 ? c * 3 + e - 2 : 0;
                    t.css({
                        "max-height": i + "px",
                        overflow: "hidden",
                        "min-height": n + "px"
                ...
                n(window).on("scroll", s)
            } else
                this.options.size && this.options.size != "auto" && t.find("li" + v).length > this.options.size && (w = t.find("li" + v + " > *").filter(":not(.div-contain)").slice(0, this.options.size).last().parent().index(),
                b = t.find("li").slice(0, w + 1).find(".div-contain").length,
                i = c * this.options.size + b * d + u,
                r.options.dropupAuto && this.$newElement.toggleClass("dropup", f > o && i < t.height()),
                t.css({
                    "max-height": i + l + a + "px",
                    overflow: "hidden"
                }),
        ...
        setWidth: function() {
            if (this.options.width == "auto") {
                ...
                this.options.width == "fit" ? (this.$menu.css("min-width", ""),
        ...
        selectPosition: function() {
            var i = this, t = n("<div />"), r, f, u = function(n) {
        ...
        setSelected: function(n, t) {
            this.$menu.find("li").eq(n).toggleClass("selected", t)
        },
        setDisabled: function(n, t) {
            t ? this.$menu.find("li").eq(n).addClass("disabled").find("a").attr("href", "#").attr("tabindex", -1) : this.$menu.find("li").eq(n).removeClass("disabled").find("a").removeAttr("href").attr("tabindex", 0)
        },
        isDisabled: function() {
        ...
        clickListener: function() {
            ...
            this.$newElement.on("click", function() {
                ...
                t.options.liveSearch || t.multiple || setTimeout(function() {
                    t.$menu.find(".selected a").trigger("focus")
                }, 10)
            });
            this.$menu.on("click", "li a", function(i) {
                var e = n(this).parent().index(), o = t.$element.val(), s = t.$element.prop("selectedIndex"), u, r, f;
                t.multiple && i.stopPropagation();
                i.preventDefault();
                t.isDisabled() || n(this).parent().hasClass("disabled") || (u = t.$element.find("option"),
                r = u.eq(e),
                t.multiple ? (f = r.prop("selected"),
                r.prop("selected", !f)) : (u.prop("selected", !1),
                r.prop("selected", !0)),
                t.multiple ? t.options.liveSearch && t.$searchbox.trigger("focus") : t.$button.trigger("focus"),
                (o != t.$element.val() && t.multiple || s != t.$element.prop("selectedIndex") && !t.multiple) && t.$element.trigger("change"))
            });
        ...
        liveSearchListener: function() {
            ...
            this.$searchbox.on("input propertychange", function() {
                t.$searchbox.val() ? (t.$menu.find("li").show().not(":icontains(" + t.$searchbox.val() + ")").hide(),
                t.$menu.find("li").filter(":visible:not(.no-results)").length ? !i.parent().length || i.remove() : (!i.parent().length || i.remove(),
                i.html('No results match "' + t.$searchbox.val() + '"').show(),
                t.$menu.find("li").last().after(i))) : (t.$menu.find("li").show(),
                !i.parent().length || i.remove());
                t.$menu.find("li.active").removeClass("active");
                t.$menu.find("li").filter(":visible:not(.divider)").eq(0).addClass("active").find("a").trigger("focus");
        ...
        val: function(n) {
            return n !== undefined ? (this.$element.val(n),
        ...
        keydown: function(t) {
            ...
            (f = n(this),
            o = f.parent(),
            f.is("input") && (o = f.parent().parent()),
            u = o.data("this"),
            u.options.liveSearch && (o = f.parent().parent()),
            u.options.container && (o = u.$menu),
            r = n("[role=menu] li:not(.divider) a", o),
            h = u.$menu.parent().hasClass("open"),
            u.options.liveSearch && (/(^9$|27)/.test(t.keyCode) && h && u.$menu.find(".active").length === 0 && (t.preventDefault(),
            u.$menu.parent().removeClass("open"),
            u.$button.trigger("focus")),
            r = n("[role=menu] li:not(.divider):visible", o),
            f.val() || /(38|40)/.test(t.keyCode) || r.filter(".active").length === 0 && (r = u.$newElement.find("li").filter(":icontains(" + w[t.keyCode] + ")"))),
            r.length) && (/(38|40)/.test(t.keyCode) ? (h || u.$menu.parent().addClass("open"),
            i = r.index(r.filter(":focus")),
            c = r.parent(":not(.disabled):visible").first().index(),
            l = r.parent(":not(.disabled):visible").last().index(),
            s = r.eq(i).parent().nextAll(":not(.disabled):visible").eq(0).index(),
            v = r.eq(i).parent().prevAll(":not(.disabled):visible").eq(0).index(),
            y = r.eq(s).parent().prevAll(":not(.disabled):visible").eq(0).index(),
            u.options.liveSearch && (r.each(function(t) {
                n(this).is(":not(.disabled)") && n(this).data("index", t)
            }),
            i = r.index(r.filter(".active")),
            c = r.filter(":not(.disabled):visible").first().data("index"),
            l = r.filter(":not(.disabled):visible").last().data("index"),
            s = r.eq(i).nextAll(":not(.disabled):visible").eq(0).data("index"),
            v = r.eq(i).prevAll(":not(.disabled):visible").eq(0).data("index"),
            y = r.eq(s).prevAll(":not(.disabled):visible").eq(0).data("index")),
            p = f.data("prevIndex"),
            t.keyCode == 38 && (u.options.liveSearch && (i -= 1),
            i != y && i > v && (i = v),
            i < c && (i = c),
            i == p && (i = l)),
            t.keyCode == 40 && (u.options.liveSearch && (i += 1),
            i == -1 && (i = 0),
            i != y && i < s && (i = s),
            i > l && (i = l),
            i == p && (i = c)),
            ...
            f.is(".dropdown-toggle") || (r.removeClass("active"),
            r.eq(i).addClass("active").find("a").trigger("focus"),
            f.trigger("focus"))) : r.eq(i).trigger("focus")) : f.is("input") || (a = [],
            r.each(function() {
                n(this).parent().is(":not(.disabled)") && n.trim(n(this).text().toLowerCase()).substring(0, 1) == w[t.keyCode] && a.push(n(this).parent().index())
            }),
            e = n(document).data("keycount"),
            e++,
            n(document).data("keycount", e),
            b = n.trim(n(":focus").text().toLowerCase()).substring(0, 1),
            b != w[t.keyCode] ? (e = 1,
            n(document).data("keycount", e)) : e >= a.length && (n(document).data("keycount", 0),
            e > a.length && (e = 1)),
            r.eq(a[e - 1]).trigger("focus")),
            /(13|32|^9$)/.test(t.keyCode) && h && (/(32)/.test(t.keyCode) || t.preventDefault(),
            u.options.liveSearch ? /(32)/.test(t.keyCode) || (u.$menu.find(".active a").trigger("click"),
            f.trigger("focus")) : n(":focus").trigger("click"),
            n(document).data("keycount", 0)),
            (/(^9$|27)/.test(t.keyCode) && h && (u.multiple || u.options.liveSearch) || /(27)/.test(t.keyCode) && !h) && (u.$menu.parent().removeClass("open"),
            u.$button.trigger("focus")))
        },
        hide: function() {
    ...
    n.fn.selectpicker = function(i, r) {
        var f = arguments, u, e = this.each(function() {
            var h, s;
            if (n(this).is("select")) {
                var c = n(this)
                ...
                if (e) {
                    ...
                    c.data("selectpicker", e = new t(this,o,r));
                typeof i == "string" && (s = i,
                e[s]instanceof Function ? ([].shift.apply(f),
                u = e[s].apply(e, f)) : u = e.options[s])
            }
        });
        return u !== undefined ? u : e
    }
    ;
...
(function(n) {
    ...
    function r(n, i) {
        var r = t.raw ? n : o(n);
        return typeof i == "function" ? i(r) : r
    }
    var u = /\+/g
...
acncm = {};
acncm.Visitor = {
    detectedVisitorGroup: function(n) {
        switch (n) {
        case 1:
    ...
    detectedClientType: function(n) {
        acncm.CacheManager.write(acncm.CacheManager.Authentication.ClientType.key, n)
    },
    detectedRegisteredUser: function(n) {
        typeof OneTrustCookieHelper != "undefined" && OneTrustCookieHelper.activeCookieCategories.FirstPartyAnalytics && acncm.CacheManager.write(acncm.CacheManager.Authentication.RegisteredUser.ID.key, n)
    },
    detectedRegisteredUserIndustry: function(n) {
        typeof OneTrustCookieHelper != "undefined" && OneTrustCookieHelper.activeCookieCategories.FirstPartyAnalytics && acncm.CacheManager.write(acncm.CacheManager.Authentication.RegisteredUser.Industry.key, n)
    },
    detectedRegisteredUserSkill: function(n) {
        typeof OneTrustCookieHelper != "undefined" && OneTrustCookieHelper.activeCookieCategories.FirstPartyAnalytics && acncm.CacheManager.write(acncm.CacheManager.Authentication.RegisteredUser.Skill.key, n)
    },
    detectedAuthType: function(n) {
        acncm.CacheManager.write(acncm.CacheManager.Authentication.Type.key, n)
    },
    detectedAuthFlag: function(n) {
        acncm.CacheManager.writeFlagCookie(acncm.CacheManager.Authentication.RegisteredUser.AuthFlag.key, n)
    },
    detectedSocialConnectUserCareerSkill: function(n) {
        typeof OneTrustCookieHelper != "undefined" && OneTrustCookieHelper.activeCookieCategories.FirstPartyAnalytics && acncm.CacheManager.write(acncm.CacheManager.Authentication.SocialConnectUser.SocialCareerSkill.key, n)
    },
    detectedSocialConnectUserIndustry: function(n) {
        typeof OneTrustCookieHelper != "undefined" && OneTrustCookieHelper.activeCookieCategories.FirstPartyAnalytics && acncm.CacheManager.write(acncm.CacheManager.Authentication.SocialConnectUser.SocialIndustry.key, n)
    },
    detectedSocialFlag: function(n) {
        acncm.CacheManager.writeFlagCookie(acncm.CacheManager.Authentication.SocialConnectUser.SocialFlag.key, n)
    }
};
acncm.EA = {
...
acncm.CacheManager = {
    ...
    isLocalStorageSupported: function() {
        var n = !1;
        return typeof Modernizr != "undefined" && typeof Modernizr.localstorage != "undefined" && (n = Modernizr.localstorage),
        n
    },
    isSessionStorageSupported: function() {
        var n = !1;
        return typeof Storage != "undefined" && (n = !0),
        n
    },
    isCookieSupported: function() {
        return typeof $.cookie != "undefined"
    },
    writeFlagCookie: function(n, t, i) {
        if (this.isCookieSupported()) {
            var r = window.location.hostname === "www.accenture.cn" ? ".accenture.cn" : ".accenture.com";
            $.cookie(n, t, {
                secure: !0,
                path: "/",
                expires: i,
    ...
    write: function(n, t, i) {
        var r = !1;
        return typeof n != "undefined" && typeof t != "undefined" && n.length > 0 && (this.isLocalStorageSupported() ? (localStorage.setItem(n, t),
        r = !0) : this.isCookieSupported() && (typeof i != "undefined" ? $.cookie(n, t, {
            secure: i
        }) : $.cookie(n, t, {
            secure: !0
        }),
    ...
    read: function(n) {
        var t = n;
        return typeof n != "undefined" && n.length > 0 && (this.isLocalStorageSupported() && (t = localStorage.getItem(n)),
        this.isCookieSupported() && (t == n || t == null) && (t = $.cookie(n))),
        t
    },
    writeSession: function(n, t) {
        var i = !1;
        return typeof n != "undefined" && typeof t != "undefined" && n.length > 0 && (this.isSessionStorageSupported() ? (sessionStorage.setItem(n, t),
        i = !0) : this.isCookieSupported() && (writeFlagCookie(),
        i = !0)),
        i
    },
    readSession: function(n) {
        var t = n;
        return typeof n != "undefined" && n.length > 0 && (this.isSessionStorageSupported() && (t = sessionStorage.getItem(n)),
        this.isCookieSupported() && (t == n || t == null) && (t = $.cookie(n))),
        t
    },
    append: function(n, t) {
        var i = this.read(n);
        return i && i.length > 0 && i.indexOf(t) < 0 && (t = i + "," + t),
        this.write(n, t)
    },
    writeUrl: function(n, t) {
        var r = !1, i;
        return typeof n != "undefined" && typeof t != "undefined" && n.length > 0 && t.length > 0 && (i = [],
        this.read(n) != undefined ? (i = JSON.parse(this.read(n)),
        i == null && (i = [""])) : i = [""],
        i.unshift(t),
        i.length >= 7 && i.pop(),
        this.write(n, JSON.stringify(i)),
        r = !0),
        r
    },
    readUrl: function(n) {
        var t = [];
        return typeof n != "undefined" && n.length > 0 && (t = this.read(n),
        (t == undefined || t == null) && (t = [])),
        t
    },
    getKeyStorageLocation: function(n) {
        var t = n;
        return this.isLocalStorageSupported() && (t = localStorage.getItem(n),
        t !== null) ? "localstorage" : this.isCookieSupported() && (t = $.cookie(n),
        t) ? "cookie" : "Cached key location not found."
    },
    remove: function(n, t, i) {
        var u = this.getKeyStorageLocation(n), r;
        u == "localstorage" ? localStorage.removeItem(n) : u == "cookie" && (r = n + "=; expires=Thu, 01-Jan-70 00:00:01 GMT;",
        i && (r += "domain=" + i + ";"),
        t && (r += "path=" + t + ";"),
        document.cookie = r)
    }
...
$(function() {
    var n = queryStringAppender.getSrcParam(), t = queryStringAppender.getSrcSession(), i;
    if (window.location.href.toLowerCase().indexOf("tlaapp") === -1 && window.OptanonActiveGroups.indexOf("2") !== -1 && (t != escape(n) && typeof n != "undefined" && n != null && sessionStorage.setItem("Append_SRCparam", n),
    linksProcessing.appendSRC(n, t),
    t !== null && n === null))
        if (i = document.location.search.substr(1).split("&"),
        i[0] !== "" || i[0] !== null) {
            let n = t + "&" + i.join("&");
...
var urlParams = window.location.search.substring(1)
  ...
  , queryStringAppender = {
    getSrcParam: function() {
        var t, n, i;
        if (urlParams != "")
            for (t = urlParams.split(new RegExp(separators.join("|"))),
            n = 0; n < t.length; n++)
                if (i = t[n].split("=")[0],
                i.toLowerCase() == "src" && t[n] !== "src=")
                    return t[n];
        return null
    },
    getSrcSession: function() {
        var n = sessionStorage.getItem("Append_SRCparam");
        return typeof n != "undefined" && n !== null ? n : null
    }
}
  , linksProcessing = {
    appendSRC: function(n, t) {
        var r = document.links, i, f, u;
        for (t !== null && t !== "src%3D" && (t = $.trim(t.replace("%3D", "="))),
        i = 0; i < r.length; i++)
            if (r[i].hostname === "philjobs.accenture.com" || r[i].hostname === "india.jobs.accenture.com" || r[i].hostname === "tas-accenture.taleo.net")
                if (r[i].href.toLowerCase().indexOf("src") === -1)
                    n !== null ? r[i].setAttribute("href", r[i].getAttribute("href") + "&" + n) : n === null && t !== null && r[i].setAttribute("href", r[i].getAttribute("href") + "&" + t);
                else
                    for (f = r[i].href.split(new RegExp(separators.join("|"))),
                    u = 0; u < f.length; u++)
                        f[u] === "src=" && (n !== null ? r[i].setAttribute("href", r[i].href.replace("src=", n)) : n === null && t !== null && r[i].setAttribute("href", r[i].href.replace("src=", t)))
    }
};
/*!
* typeahead.js 0.10.4
...
(function(n) {
    var t = function() {
      ...
      , y = function() {
        ...
        return i = n && window.JSON ? {
            ...
            get: function(t) {
                ...
                e(n.getItem(this._prefix(t)))
            },
            set: function(i, r, e) {
                return t.isNumber(e) ? n.setItem(this._ttlKey(i), f(u() + e)) : n.removeItem(this._ttlKey(i)),
                n.setItem(this._prefix(i), f(r))
            },
            remove: function(t) {
            ...
            clear: function() {
                for (var r, i = [], u = n.length, t = 0; t < u; t++)
            ...
            isExpired: function(i) {
                var r = e(n.getItem(this._ttlKey(i)));
                return t.isNumber(r) && u() > r ? !0 : !1
            }
        } : {
            get: t.noop,
            set: t.noop,
      ...
      , s = function() {
        ...
        function i(t) {
            ...
            this._cache = t.cache === !1 ? new o(0) : e
        }
        function s(i) {
            return function(r, u) {
                function e(n) {
        ...
        t.mixin(i.prototype, {
            _get: function(n, t, i) {
                ...
                function c() {
                    r--;
                    delete u[n];
                    e.onDeckRequestArgs && (e._get.apply(e, e.onDeckRequestArgs),
                    e.onDeckRequestArgs = null)
                }
                var e = this, o;
                this.cancelled || n !== this.lastUrl || ((o = u[n]) ? o.done(s).fail(h) : r < f ? (r++,
                u[n] = this._send(n, t).done(s).fail(h).always(c)) : this.onDeckRequestArgs = [].slice.call(arguments, 0))
            },
            get: function(n, i, r) {
                var u;
                ...
                this.cancelled = !1,
                this.lastUrl = n,
                (u = this._cache.get(n)) ? t.defer(function() {
                    r && r(null, u)
                }) : this._get(n, i, r),
                !!u
            },
      ...
      , p = function() {
        ...
        return t.mixin(i.prototype, {
            ...
            get: function(n) {
                var u = this, o, i;
                return o = r(this.queryTokenizer(n)),
                t.each(o, function(n) {
                    var t, r, o, f;
                    if (i && i.length === 0)
                        return !1;
                    for (t = u.trie,
                    r = n.split(""); t && (o = r.shift()); )
                        t = t.children[o];
                    if (t && r.length === 0)
                        f = t.ids.slice(0),
                        i = i ? e(i, f) : f;
    ...
    (function(i) {
        ...
        function u(t) {
            ...
            this.storage = this.cacheKey ? new y(this.cacheKey) : null
        }
        function o(n) {
            function i(t) {
                return t.sort(n)
        ...
        t.mixin(u.prototype, {
            ...
            _getFromRemote: function(n, t) {
                function f(n, r) {
                    n ? t([]) : t(i.remote.filter ? i.remote.filter(r) : r)
                }
                var i = this, r, u;
                if (this.transport)
                    return n = n || "",
                    u = encodeURIComponent(n),
                    r = this.remote.replace ? this.remote.replace(this.remote.url, n) : this.remote.url.replace(this.remote.wildcard, u),
                    this.transport.get(r, this.remote.ajax, f)
            },
            ...
            _initialize: function() {
                function f() {
                    u.add(t.isFunction(i) ? i() : i)
                }
                var u = this, i = this.local, r;
            ...
            get: function(n, i) {
                ...
                r.length < this.limit ? f = this._getFromRemote(n, e) : this._cancelLastRemoteRequest();
    ...
    var r = function() {
      ...
      , i = function() {
        "use strict";
        var i;
        return i = n(".redesign-search-page").length === 0 && n(".job-search-hero-block").length === 0 && n(".reinvent-locations-hero-module").length === 0 ? {
            wrapper: {
                position: "relative",
      ...
      , l = function() {
        ...
        function i(i) {
            ...
            o = t.bind(this._onFocus, this),
            s = t.bind(this._onKeydown, this),
            h = t.bind(this._onInput, this),
            this.$hint = n(i.hint),
            this.$input = n(i.input).on("blur.tt", e).on("focus.tt", o).on("keydown.tt", s),
            this.$hint.length === 0 && (this.setHint = this.getHint = this.clearHint = this.clearHintIfInvalid = t.noop),
            t.isMsie())
                this.$input.on("keydown.tt keypress.tt cut.tt paste.tt", function(n) {
                    r[n.which || n.keyCode] || t.defer(t.bind(u._onInput, u, n))
                });
            else
      ...
      , u = function() {
        ...
        function l(i, r) {
            function u(t) {
                return n(".job-search-hero-block").is(":visible") ? "<a class='suggestion-item'>" + r(t) + "<\/a>" : n(".about-hero-wrapper").is(":visible") ? "<a class='suggestion-item'>" + r(t) + "<\/a>" : n(".redesign-search-page .search-hero-keywords").is(":focus") ? "<p><strong>" + r(t) + "<\/strong><\/p>" : n(".reinvent-locations-hero-module .reinvent-location-keywords").is(":focus") ? "<p><strong>" + r(t) + "<\/strong><\/p>" : "<p>" + r(t) + "<\/p>"
            }
            return {
                empty: i.empty && t.templatify(i.empty),
        ...
        t.mixin(u.prototype, e, {
            _render: function(u, e) {
                ...
                function p() {
                    ...
                    var l, a;
                    return l = n(r.suggestions).css(i.suggestions),
                    a = t.map(e, v),
                    l.append.apply(l, a),
                    n(".redesign-search-page .search-hero-keywords").is(":focus") || n(".job-search-hero-block .search-bar").is(":focus") || n(".reinvent-locations-hero-module .reinvent-location-keywords").is(":focus") ? h.highlight && c({
                ...
                if (this.$el) {
                    ...
                    this.$el.empty();
                    l = e && e.length;
                    !l && this.templates.empty ? this.$el.html(y()).prepend(h.templates.header ? a() : null).append(h.templates.footer ? v() : null) : l && this.$el.html(p()).prepend(h.templates.header ? a() : null).append(h.templates.footer ? v() : null);
      ...
      , w = function() {
        ...
        return t.mixin(r.prototype, e, {
            ...
            _show: function() {
                ...
                n(".reinvent-location-keywords").length === 0)
                    if (n(".redesign-search-page .tt-suggestions").is(":visible")) {
                        if (r = n("#search-form-label.search-hero-keywords.autocomplete-search-field").attr("data-view-all-results-toggle") !== null && typeof n("#search-form-label.search-hero-keywords.autocomplete-search-field").attr("data-view-all-results-toggle") != "undefined" ? n("#search-form-label.search-hero-keywords.autocomplete-search-field").attr("data-view-all-results-toggle").toLowerCase() : "",
                        r === "true") {
                            var o = n(".redesign-search-page .tt-input.search-hero-keywords").val()
                              , u = ".tt-suggestion.view-all-text-container"
                              , s = n(".search-hero-keywords").attr("data-view-all-results")
                              , f = n(".tt-dataset-keywordSuggestions .tt-suggestions .tt-suggestion .view-all-text")
                              , e = n(".tt-dataset-keywordSuggestions .tt-suggestions .tt-suggestion .arrow-strong");
                            jQuery("<li/>", {
                            ...
                            n(u).attr("data-attribute-view-all-keyword", o);
                            f.attr("data-analytics-link-name", n(".tt-dataset-keywordSuggestions .tt-suggestions .tt-suggestion .view-all-text").text().toLowerCase());
                            f.attr("data-analytics-content-type", "search activity");
                            e.attr("data-analytics-link-name", n(".tt-dataset-keywordSuggestions .tt-suggestions .tt-suggestion .view-all-text").text().toLowerCase());
                            e.attr("data-analytics-content-type", "search activity")
                        }
                    } else if (n(".job-search-hero-block-form .tt-suggestions").is(":visible") && n(".job-search-hero-block .tt-dataset-keywordSuggestions .tt-suggestions").is(":visible"))
                        for (i = n(".job-search-hero-block .tt-suggestions .tt-suggestion .suggestion-item"),
                        t = 0; t < i.length; t++)
                            i[t].setAttribute("data-analytics-link-name", i[t].innerText.toLowerCase()),
                            i[t].setAttribute("data-analytics-content-type", "careers job search")
            },
            _getSuggestions: function() {
                n(".recent-searches-container.tt-dataset-keywordRecentSearches .recent-search").on("mouseenter", function() {
                    n(".recent-searches-container.tt-dataset-keywordRecentSearches .recent-search").removeAttr("id", "selectedOption");
            ...
            _moveCursor: function(t) {
                if (!n(".redesign-search-page .tt-dataset-keywordRecentSearches").is(":visible") && !n(".job-search-hero-block .tt-dataset-keywordRecentSearches").is(":visible")) {
                    var r, u, i, f;
                    if (!this.isOpen)
                        return;
                    if (u = this._getCursor(),
                    r = this._getSuggestions(),
                    this._removeCursor(),
                    i = r.index(u) + t,
                    i = (i + 1) % (r.length + 1) - 1,
                    i === -1) {
                    ...
                    i < -1 && (i = r.length - 1);
                    this._setCursor(f = r.eq(i));
                    this._ensureVisible(f)
                }
            },
            ...
            setLanguageDirection: function(n) {
                this.$menu.css(n === "ltr" ? i.ltr : i.rtl)
            },
            ...
            getDatumForSuggestion: function(t) {
                ...
                if (t.length) {
                    ...
                    s = n(".search-hero-form .tt-dataset-keywordSuggestions .tt-suggestions .tt-suggestion p"),
                    s.attr("data-analytics-content-type", "search activity"),
                    r = 0; r < n(".search-hero-form .tt-dataset-keywordSuggestions .tt-suggestions .tt-suggestion p").length; r++)
                        o = s[r].innerText,
                        i = s[r],
                        i.setAttribute("data-analytics-link-name", o.toLowerCase());
                    if (n(".reinvent-location-hero-content-container").length !== 0) {
                        var f = n(".reinvent-location-hero-content-container .tt-dataset-keywordSuggestions .tt-suggestions .tt-suggestion p")
                          , l = n(".reinvent-location-result-area")
                          , c = n(".reinvent-locations-hero-module");
                        for (f.attr("data-analytics-content-type", "engagement"),
                        f.attr("data-linktype", "engagement"),
                        e = 0; e < f.length; e++)
                            o = f[e].innerText,
                            i = f[e],
                            i.setAttribute("data-analytics-link-name", o.toLowerCase()),
                            l.length === 0 && c.attr("data-attribute-hero-home-link") !== "" && i.setAttribute("href", c.attr("data-attribute-hero-home-link").replace("{0}", siteName))
                    }
                }
                return h
            },
      ...
      , b = function() {
        ...
        function e(t, f) {
            ...
            s.val("").removeData().addClass("tt-hint").prop("readonly", !0).prop("required", !1).removeAttr("name placeholder").attr({
                autocomplete: "off",
                spellcheck: "false",
        ...
        function s(n) {
            ...
            t.each(i.data(u), function(n, r) {
                t.isUndefined(n) ? i.prop(r, !1) : i.attr(r, n)
            });
        ...
        return t.mixin(f.prototype, {
            ...
            _onUpKeyed: function() {
                ...
                this.dropdown.open();
                n(".tt-suggestion.view-all-text-container").length > 1 && n(".tt-suggestion.view-all-text-container")[0].remove()
            },
            ...
            _onRightKeyed: function() {
                n(".redesign-search-page .search-hero-keywords").is(":focus") || n(".job-search-hero-block .search-bar").is(":focus") || this.dir === "ltr" && this._autocomplete()
            },
            ...
            _updateHint: function() {
                ...
                n(".redesign-search-page .search-hero-keywords").is(":focus") || n(".job-search-hero-block .search-bar").is(":focus") || (i && this.dropdown.isVisible() && !this.input.hasOverflow() ? (r = this.input.getInputValue(),
                f = l.normalizeQuery(r),
                e = t.escapeRegExChars(f),
                o = new RegExp("^(?:" + e + ")(.+$)","i"),
                u = o.exec(i.value),
                u ? this.input.setHint(r + u[1]) : this.input.clearHint()) : this.input.clearHint())
            },
    ...
    (function() {
        ...
        n.fn.typeahead = function(t) {
            var u;
            return r[t] && t !== "initialize" ? (u = this.filter(function() {
...
(function() {
    function n(n, t) {
        function w(n, t) {
            return c.getComputedStyle || (c.getComputedStyle = function(n) {
                return this.el = n,
            ...
            c.getComputedStyle(n, null).getPropertyValue(t)
        }
        function b(t) {
            var i = t || n.clientHeight
              , r = k(n);
            return Math.max(Math.floor(i / r), 0)
        }
        function tt(t) {
            var i = k(n);
            return i * t
        ...
        function k(n) {
            var t = w(n, "line-height");
            return t == "normal" && (t = parseInt(w(n, "font-size")) * 1.2),
            parseInt(t)
        }
        function h(t) {
            return t.lastChild ? t.lastChild.children && t.lastChild.children.length > 0 ? h(Array.prototype.slice.call(t.children).pop()) : t.lastChild && t.lastChild.nodeValue && t.lastChild.nodeValue != "" && t.lastChild.nodeValue != i.truncationChar ? t.lastChild : (t.lastChild.parentNode.removeChild(t.lastChild),
            h(n)) : t
        }
        function a(t, f) {
            function c() {
                e = i.splitOnChars.slice(0);
                r = e[0];
                u = null;
                l = null
            }
            if (f) {
                var o = "";
                if (t.nodeValue && (o = t.nodeValue.replace(i.truncationChar, "")),
                u || (r = e.length > 0 ? e.shift() : "",
                u = o.split(r)),
                u.length > 1 ? (l = u.pop(),
                v(t, u.join(r))) : u = null,
                s && (t.nodeValue = t.nodeValue.replace(i.truncationChar, ""),
                n.innerHTML = t.nodeValue + " " + s.innerHTML + i.truncationChar),
                u) {
                    if (n.clientHeight <= f)
                        if (e.length >= 0 && r != "")
                            v(t, u.join(r) + r + l),
        ...
        var e, r, u, l, d, y;
        t = t || {};
        var it = this, c = window, i = {
            clamp: t.clamp || 2,
            useNativeClamp: typeof t.useNativeClamp != "undefined" ? t.useNativeClamp : !0,
            splitOnChars: t.splitOnChars || [".", "-", "â€“", "â€”", " "],
            animate: t.animate || !1,
            truncationChar: t.truncationChar || "â€¦",
            truncationHTML: t.truncationHTML
        }, o = n.style, g = n.innerHTML, nt = typeof n.style.webkitLineClamp != "undefined", f = i.clamp, p = f.indexOf && (f.indexOf("px") > -1 || f.indexOf("em") > -1), s;
        return i.truncationHTML && (s = document.createElement("span"),
        s.innerHTML = i.truncationHTML),
        e = i.splitOnChars.slice(0),
        r = e[0],
        f == "auto" ? f = b() : p && (f = b(parseInt(f))),
        nt && i.useNativeClamp ? (o.overflow = "hidden",
        o.textOverflow = "ellipsis",
        o.webkitBoxOrient = "vertical",
        o.display = "-webkit-box",
        o.webkitLineClamp = f,
        p && (o.height = i.clamp + "px")) : (y = tt(f),
        y <= n.clientHeight && (d = a(h(n), y))),
        {
            original: g,
            clamped: d
        }
 ...
 */
(function(n, t, i, r) {
    n.fn.moduleClamping = function(i) {
        function s(t, i, o, s) {
            var y = n(t), h = y.find(u.titleSelector)[0], c = y.find(u.bodySelector)[0], g = t.offsetHeight, a = 0, p, w, b, k, v, d;
            h != r && h != null && (p = n(h).height(),
            w = n(h).css("line-height").replace("px", ""),
            a = Math.round(p / parseInt(w)),
            (a > i || f == !0) && (l(h),
            $clamp(h, {
                clamp: i
            })),
            a > i && (a = i));
            c != r && c != null && (b = n(c).height(),
            k = n(c).css("line-height").replace("px", ""),
            bodyLines = Math.round(b / parseInt(k)),
            v = s - a,
            (bodyLines > v || f == !0) && (l(c),
            v > o && (v = o),
            $clamp(c, {
            ...
            d = t.offsetHeight;
            e && g != d && n(t).addClass("touch-inactive")
        }
        function l(t) {
            n(t).hasClass("clamp") || (n(t).addClass("clamp").data("clamp-id", o),
            c[o] = n(t).html(),
            o++)
        }
        function a(t) {
            var i = n(t).data("clamp-id");
            n(t).html(c[i])
        }
        function y(t) {
            if (e) {
                var i = n(t).find("a.articleHeadline");
                n(t).on("click", function() {
                    var r = n(this);
                    r.hasClass("touch-inactive") ? (v(t),
                    i.removeAttr("onClick"),
                    r.removeClass("touch-inactive")) : (h(t),
                    i.attr("onClick", "return false;"),
                    r.addClass("touch-inactive"))
                });
                n(t).on("mouseleave", function() {
                    h(t);
                    i.attr("onClick", "return false;");
                    n(this).addClass("touch-inactive")
                })
            } else
        ...
        function v(t) {
            var i = n(t)
              , o = i.find(u.titleSelector)[0]
              , e = i.find(u.bodySelector)[0];
            return o != r && o != null && a(o),
            e != r && e != null && a(e),
            f = !0,
            s(i, 50, 50, 100),
            u.onMouseOver.call(i),
            n(e).attr("style", ""),
            !1
        }
        function h(i) {
            var o = n(i), h = n(i).find("a.articleHeadline"), c, l, a, r, v;
            return o.css("opacity", 1),
            c = i.offsetHeight,
            f = !1,
            s(o, u.titleMaximumRowCount, u.bodyMaximumRowCount, u.totalMaximumRowCount),
            l = n(i).hasClass("mouse-entered-onload"),
            a = i.offsetHeight,
            e && !l && c == a && (r = h.attr("href"),
            v = h.attr("target"),
            r && r.length > 0 && (v == "_blank" ? t.open(r, "_blank") : t.location = r)),
            u.onMouseOut.call(o),
            !1
        }
        var u = n.extend({}, n.fn.moduleClamping.options, i)
          , o = 0
          , c = []
          , p = n(this)
          , f = !1
          , e = "ontouchstart"in t || t.navigator.msMaxTouchPoints;
        return this.each(function() {
            n(this).find(u.moduleSelector).each(function() {
                n(this).find(u.titleSelector).hasClass("clamp") || (s(this, u.titleMaximumRowCount, u.bodyMaximumRowCount, u.totalMaximumRowCount),
                u.mouseOver == "expand" && (y(this),
                e && (n(this).find("a.articleHeadline").attr("onClick", "return false;").addClass("touch-inactive"),
                n(this).addClass("touch-inactive"))))
            })
        }).addClass("clamp-container")
    }
    ;
    n.fn.moduleClamping.options = {
 ...
 */
(function(n, t, i) {
    n.fn.smartModuleClamping = function(r) {
        function e(t, i) {
            typeof o != "undefined" && n.each(o, function(r, u) {
                var h = t.find(r)[0], o, e, c;
                typeof h != "undefined" && (o = i,
                e = n(h),
                o != f && (s || typeof e.data("clamp-text") != "undefined" || e.data("clamp-text", encodeURI(e.html())),
                o = u,
                c = e.data("maxline"),
                typeof c != "undefined" && (o = c)),
                e.hasClass("clamp-list") == !1 ? s || i != f ? $clamp(h, {
                    clamp: o,
                    useNativeClamp: !0
                }) : e.html(decodeURI(e.data("clamp-text"))) : o != f ? e.addClass("clamp-truncate").css("height", o) : e.removeClass("clamp-truncate").css("height", ""))
            })
        }
        var u = n.extend({}, n.fn.smartModuleClamping.options, r)
          , o = JSON.parse(u.clampSelectors)
          , h = "ontouchstart"in t || t.navigator.msMaxTouchPoints
          , f = 9999
          , s = typeof i.body.style.webkitLineClamp != "undefined";
        return this.each(function() {
            var t = n(this).find(u.moduleSelector);
            if (t.on("mouseenter", function() {
                u.expandOnHover == !0 && (e(n(this), f),
                n(this).find("p").attr("style", ""));
                u.onMouseEnter.call()
            }).on("mouseleave", function() {
                u.expandOnHover == !0 && e(n(this), 0);
                u.onMouseLeave.call()
            }).each(function() {
                e(n(this), 0)
            }),
            h && u.expandOnMobile == "true")
                t.on("click", function() {
                    t.hasClass("touch-clamp") ? (e(n(this), 0),
                    t.removeClass("touch-clamp")) : (e(n(this), f),
                    t.addClass("touch-clamp"))
                })
        })
    }
    ;
    n.fn.smartModuleClamping.options = {
        moduleSelector: ".module-article",
...
function(n) {
    ...
    function ut(rt, ut) {
        ...
        function ki(n) {
            ...
            return r && u.touches.length > 0 ? (hu(),
            !0) : (pr() && (ot = pi),
            n.preventDefault(),
            oi = dt(),
            st = kr(),
        ...
        function ti(r, s, h) {
            ...
            return h == y ? (s === i || s === t) && (clearTimeout(hi),
            tr() && !ru() ? (kt = dt(),
            hi = setTimeout(n.proxy(function() {
                kt = null;
                ft.trigger("tap", [r.target]);
                ut.tap && (c = ut.tap.call(ft, r, r.target))
            }, this), ut.doubleTapThreshold)) : (kt = null,
            ft.trigger("tap", [r.target]),
            ut.tap && (c = ut.tap.call(ft, r, r.target)))) : h == g ? (s === i || s === t) && (clearTimeout(hi),
            kt = null,
            ft.trigger("doubletap", [r.target]),
            ut.doubleTap && (c = ut.doubleTap.call(ft, r, r.target))) : h == nt && (s === i || s === t) && (clearTimeout(hi),
            kt = null,
...
//# sourceMappingURL=preBodyScriptRedesignBundle.min.js.map
