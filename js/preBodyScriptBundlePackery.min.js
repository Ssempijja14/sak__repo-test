...
(function(n) {
             ...
             n.fn[r] = function(f) {
                 ...
                 if (typeof f == "string") {
                     ...
                     c = this.length; o < c; o++) {
                         ...
                         if (typeof e[f] != "function" || f.charAt(0) === "_") {
 ...
 (function(n) {
     ...
     typeof define == "function" && define.amd ? define("classie/classie", u) : n.classie = u
 }
 )(window);
 /*!
 ...
 function(n) {
     ...
     var t = document.defaultView
       , r = t && t.getComputedStyle ? function(n) {
 ...
 function(n) {
     function t() {
         ...
         n.prototype.overlaps = function(n) {
             var t = this.x + this.width
               ...
               , r = n.x + n.width
               , u = n.y + n.height;
             return this.x < r && t > n.x && this.y < u && i > n.y
         }
         ,
         n.prototype.getMaximalFreeRects = function(t) {
             if (!this.overlaps(t))
                 return !1;
             var r = [], i, e = this.x + this.width, o = this.y + this.height, u = t.x + t.width, f = t.y + t.height;
     ...
     ;
     typeof define == "function" && define.amd ? define("packery/js/rect", t) : (n.Packery = n.Packery || {},
     n.Packery.Rect = t())
 }(window),
 function(n) {
     function t(n) {
         ...
         t.prototype.pack = function(n) {
             for (var i, t = 0, r = this.spaces.length; t < r; t++)
                 if (i = this.spaces[t],
                 i.canFit(n)) {
         ...
         t.prototype.placed = function(n) {
             for (var u, f, i = [], r = 0, e = this.spaces.length; r < e; r++)
                 u = this.spaces[r],
         ...
         t.mergeRects = function(n) {
             for (var u, r, f, i, o, s, h, t = 0, e = n.length; t < e; t++)
                 if (u = n[t],
                 u)
                     for (r = n.slice(0),
                     r.splice(t, 1),
 ...
 function(n) {
     ...
     typeof define == "function" && define.amd ? define("packery/js/item", ["get-style-property/get-style-property", "outlayer/outlayer", "./rect"], t) : n.Packery.Item = t(n.getStyleProperty, n.Outlayer, n.Packery.Rect)
 }(window);
 /*!
      * Packery v1.2.3
      * bin-packing layout library
 ...
 (function(n) {
     function t(n, t, i, r, u, f) {
         ...
         e.prototype._setRectSize = function(n, i) {
             var o = t(n), r = o.outerWidth, u = o.outerHeight, f, e;
             (r || u) && (f = this.columnWidth + this.gutter,
             e = this.rowHeight + this.gutter,
             r = this.columnWidth ? Math.ceil(r / f) * f : r + this.gutter,
             u = this.rowHeight ? Math.ceil(u / e) * e : u + this.gutter);
             i.width = Math.min(r, this.packer.width);
             i.height = Math.min(u, this.packer.height)
         }
         ,
         ...
         e.prototype.fit = function(n, t, i) {
             ...
             r.getSize(),
             r.isPlacing = !0,
             t = t === undefined ? r.rect.x : t,
             i = i === undefined ? r.rect.y : i,
         ...
         e.prototype._bindFitEvents = function(n) {
             function r() {
                 (i++,
                 i === 2) && t.emitEvent("fitComplete", [t, n])
             }
             var t = this
               , i = 0;
         ...
         e.prototype.itemDragEnd = function(t) {
             ...
             if (n.add(i.element, "is-positioning-post-drag"),
     ...
     typeof define == "function" && define.amd ? define(["classie/classie", "get-size/get-size", "outlayer/outlayer", "packery/js/rect", "packery/js/packer", "packery/js/item"], t) : n.Packery = t(n.classie, n.getSize, n.Outlayer, n.Packery.Rect, n.Packery.Packer, n.Packery.Item)
 }
 )(window);
 //# sourceMappingURL=preBodyScriptBundlePackery.min.js.map
